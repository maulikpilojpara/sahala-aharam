  ...
  <div class="top-header py-1">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-start">
        <div class="px-2 py-1">
          <a href="tel:+919701111633" class="d-flex align-items-center">
        ...
        <div class="px-2 py-1">
          <a class="d-flex align-items-center" href="mailto:support@greenstation.co">
            ...
            support@greenstation.co
          </a>
        </div>
        <div class="px-2 py-1">
          <a class="d-flex align-items-center" href="mailto:info@greenstation.co">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill me-2" viewBox="0 0 16 16">
              <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
            </svg>
            info@greenstation.co
          </a>
        </div>
      </div>
    </div>

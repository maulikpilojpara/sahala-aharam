    ...
    <div class="container">
      ...
      <div class="offer-carousel owl-carousel owl-theme title-nav">
        <div class="item">
          <div
            class="offer-box"
            style="background-color: #3a261d; color: #3a261d"
          >
            <h4>25% OFF</h4>
            <h3>Millets</h3>
            <div class="more-link">
            ...
            <div class="img">
              <img src="/offer-banner/1.png" class="d-block" />
            </div>
          </div>
        </div>
        <div class="item">
          <div
            class="offer-box"
            style="background-color: #ffb12b; color: #ffb12b"
          >
            <h4>25% OFF</h4>
            ...
            <div class="img">
              <img src="/offer-banner/2.png" class="d-block" />
            </div>
          </div>
        </div>
        <div class="item">
          <div
            class="offer-box"
            style="background-color: #69bd45; color: #69bd45"
          >
            <h4>25% OFF</h4>
            <h3>Health CARE</h3>
            <div class="more-link">
            ...
            <div class="img">
              <img src="/offer-banner/3.png" class="d-block" />
            </div>
          </div>
        </div>
        <div class="item">
          <div
            class="offer-box"
            style="background-color: #005ec6; color: #005ec6"
          >
            <h4>25% OFF</h4>
            <h3>Sweeteners</h3>
            <div class="more-link">
            ...
            <div class="img">
              <img src="/offer-banner/4.png" class="d-block" />
            </div>
          </div>
        </div>
        <div class="item">
